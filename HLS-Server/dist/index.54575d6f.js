...
})({"h0RHV":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "f532323054575d6f";
...
function _checkAndCreateFileStateObject2(files, fileDescriptor) {
    ...
    if (onBeforeFileAddedResult === false) {
        ...
        const error1 = new _Restricter.RestrictionError("Cannot add the file because onBeforeFileAdded returned false.");
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gdQUw"}],"gdQUw":[function(require,module,exports) {
...
globalThis.AggregateError = class AggregateError1 extends Error {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gdQUw"}],"arliH":[function(require,module,exports) {
"use strict";
...
!function(e, t) {
    ...
    var s = "undefined" != typeof self ? self : global;
    const i = "undefined" != typeof navigator, n = i && "undefined" == typeof HTMLImageElement, r = !("undefined" == typeof global || "undefined" == typeof process || !process.versions || !process.versions.node), a = s.Buffer, h = !!a, f = (e)=>void 0 !== e;
    function l(e) {
    ...
    class p {
        ...
        set(e, t, s = p) {
            return e instanceof DataView || e instanceof p ? e = new Uint8Array(e.buffer, e.byteOffset, e.byteLength) : e instanceof ArrayBuffer && (e = new Uint8Array(e)), e instanceof Uint8Array || o("BufferView.set(): Invalid data argument."), this.toUint8().set(e, t), new s(this, t, e.byteLength);
        }
        subarray(e, t) {
    ...
    class G extends Y {
        ...
        constructor(e, s, i, n){
            if (super(), t(this, "enabled", !1), t(this, "skip", new Set), t(this, "pick", new Set), t(this, "deps", new Set), t(this, "translateKeys", !1), t(this, "translateValues", !1), t(this, "reviveValues", !1), this.key = e, this.enabled = s, this.parse = this.enabled, this.applyInheritables(n), this.canBeFiltered = $.includes(e), this.canBeFiltered && (this.dict = I.get(e)), void 0 !== i) {
    ...
    class Q extends Y {
        ...
        setupGlobalFilters(e, t, s, i = s) {
            if (e && e.length) {
                ...
                let t1 = Z(e, s);
                for (let [e2, s1] of t1)te(this[e2].pick, s1), this[e2].enabled = !0;
            } else if (t && t.length) {
                let e3 = Z(t, s);
                for (let [t2, s2] of e3)te(this[t2].skip, s2);
            }
        }
        ...
        traverseTiffDependencyTree() {
            ...
            i.needed && (t.deps.add(D), e.deps.add(D)), t.needed && e.deps.add(E), s.needed && e.deps.add(_), this.tiff.enabled = $.some((e)=>!0 === this[e].enabled) || this.makerNote || this.userComment;
            for (let e1 of $)this[e1].finalizeFilters();
        }
        get onlyTiff() {
    ...
    class se {
        constructor(e){
            t(this, "parsers", {}), t(this, "output", {}), t(this, "errors", []), t(this, "pushToErrors", (e)=>this.errors.push(e)), this.options = Q.useCached(e);
        }
        async read(e) {
        ...
        async parse() {
            ...
            var s;
            return this.setup(), this.options.silentErrors ? (await this.executeParsers().catch(this.pushToErrors), t.push(...this.fileParser.errors)) : await this.executeParsers(), this.file.close && this.file.close(), this.options.silentErrors && t.length > 0 && (e.errors = t), l(s = e) ? void 0 : s;
        }
    ...
    class re {
        ...
        constructor(e, s = {}, i){
            ...
            }), this.chunk = this.normalizeInput(e), this.file = i, this.type = this.constructor.type, this.globalOptions = this.options = s, this.localOptions = s[this.type], this.canTranslate = this.localOptions && this.localOptions.translate;
        }
        translate() {
    ...
    class le extends class {
            ...
            t(this, "errors", []), t(this, "ensureSegmentChunk", async (e)=>{
                ...
                if (this.file.chunked) {
                    if (this.file.available(t, s)) e.chunk = this.file.subarray(t, s);
                        ...
                        o(`Couldn't read segment: ${JSON.stringify(e)}. ${t1.message}`);
                    }
                ...
                return e.chunk;
            }), this.extendOptions && this.extendOptions(e), this.options = e, this.file = s, this.parsers = i;
        }
        injectSegment(e, t) {
        ...
        setupSegmentFinderArgs(e) {
            !0 === e ? (this.findAll = !0, this.wanted = new Set(b.keyList())) : (e = void 0 === e ? b.keyList().filter((e)=>this.options[e].enabled) : e.filter((e)=>this.options[e].enabled && b.has(e)), this.findAll = !1, this.remaining = new Set(e), this.wanted = new Set(e)), this.unfinishedMultiSegment = !1;
        }
    ...
    class ue extends re {
        ...
        parseTag(e, t, s) {
            ...
            if (a * r <= 4 ? e += 8 : e = i.getUint32(e + 8), (n < 1 || n > 13) && o(`Invalid TIFF value type. block: ${s.toUpperCase()}, tag: ${t.toString(16)}, type: ${n}, offset ${e}`), e > i.byteLength && o(`Invalid TIFF value offset. block: ${s.toUpperCase()}, tag: ${t.toString(16)}, type: ${n}, offset ${e} is outside of chunk size ${i.byteLength}`), 1 === n) return i.getUint8Array(e, r);
    ...
    if (e.rotateCanvas = !0, e.rotateCss = !0, "object" == typeof navigator) {
        let t1 = navigator.userAgent;
        if (t1.includes("iPad") || t1.includes("iPhone")) {
            let s1 = t1.match(/OS (\d+)_(\d+)/);
            if (s1) {
                let [, t2, i1] = s1, n1 = Number(t2) + .1 * Number(i1);
                e.rotateCanvas = n1 < 13.4, e.rotateCss = !1;
            }
        } else if (t1.includes("OS X 10")) {
            let [, s2] = t1.match(/OS X 10[_.](\d+)/);
            e.rotateCanvas = e.rotateCss = Number(s2) < 15;
        }
        if (t1.includes("Chrome/")) {
            let [, s3] = t1.match(/Chrome\/(\d+)/);
            e.rotateCanvas = e.rotateCss = Number(s3) < 81;
        } else if (t1.includes("Firefox/")) {
            let [, s4] = t1.match(/Firefox\/(\d+)/);
            e.rotateCanvas = e.rotateCss = Number(s4) < 77;
        }
    }
    class Oe extends p {
        constructor(...e){
    ...
    }), e.Exifr = se, e.Options = Q, e.allFormatters = H, e.chunkedProps = M, e.createDictionary = B, e.default = pe, e.extendDictionary = V, e.fetchUrlAsArrayBuffer = U, e.fileParsers = y, e.fileReaders = w, e.gps = async function(e) {
        let t = new se(me);
        await t.read(e);
        let s = await t.parse();
        if (s && s.gps) {
    ...
    }, e.gpsOnlyOptions = me, e.inheritables = X, e.orientation = we, e.orientationOnlyOptions = be, e.otherSegments = N, e.parse = ie, e.readBlobAsArrayBuffer = x, e.rotation = async function(t) {
        let s = await we(t);
        return Object.assign({
            canvas: e.rotateCanvas,
            css: e.rotateCss
        }, ke[s]);
    }, e.rotations = ke, e.segmentParsers = b, e.segments = R, e.segmentsAndBlocks = K, e.tagKeys = I, e.tagRevivers = T, e.tagValues = L, e.thumbnail = async function(e) {
        let t = new se(ye);
        await t.read(e);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gdQUw"}],"cBIHv":[function(require,module,exports) {
"use strict";
...
},{}]},["h0RHV","2PTrU"], "2PTrU", "parcelRequire753d")
